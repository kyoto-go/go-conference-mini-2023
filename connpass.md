## What is Go Conference mini? / Go Conference miniとは？
...
## How to join the conference? / 参加方法
...
無断キャンセルを行った方には、次回以降のGo Conferenceイベントの参加の優先順位下げさせて頂く可能性があります。具体的には、以下のように無断キャンセルを行った方を対象といたします。
