...
Goコミュニティの裾野を広げ、地域のコミュニティで活躍する方を応援する目的で、SessionとLightning Talkに1枠ずつの学生枠・地元枠を設けます。これらの枠に該当するトークは、通常枠での選考後、選考を通過しなかった場合に再度それぞれの選考枠で選考を行います。

* 学生枠: 学生の方（社会人学生は除きます）
* 地元枠: 京都に在住、通勤、通学されている方
